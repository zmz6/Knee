...
class TestDataSets(Dataset):
    def __init__(self, base_dir=None, split='train', num=None, num_class=7, transform=None, cv=1):
        ...
        # liu 69 wang
        liu_test1_label_file = "all_test_annotation/wang_test1"
        liu_test2_label_file = "all_test_annotation/wang_test2"

        xu_test_label_file = "annotation"

        self.xu_test = self.get_annotation(xu_test_label_file)
    ...
    def __getitem__(self, idx):
        ...
        xu_test_label, _  = self.get_data(self.xu_test, case)

        space = self.space[case]

        h, w = image.shape
        kpts_wrapped = sld.KeyPoints(mean_liu_label, h, w)
        ...
        sample = {
            ...
            'ori_h': h,
            'ori_w': w,
            'ori_kp': mean_liu_label,
            'ori_1': liu_test1_label,
            'ori_2': liu_test2_label,
            'gt_kp': xu_test_label,
            'image': img,
            'space': space,
            'target_hm': target_hm,
